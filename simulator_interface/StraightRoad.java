...
public class StraightRoad {
    ...
    public static class AnimateThread extends Thread {
        ...
        public AnimateThread(JTable table, int x, int y) {
            this.table = table;
    ...
    public void mouseClicked(java.awt.event.MouseEvent evt) {
        track = table.rowAtPoint(evt.getPoint());
            ...
            for (int y = 0; y < roadYLen; y++) {
                for (int x = 0; x < roadXLen; x++) {
                    if (road[x][y] != -1) {
                        ...
                        table.setValueAt(road[x][y], y+track, x);
                    } else {
                        table.setValueAt("", y+track, x);
                    }
                }
            }
...
//                            has a car been found in front of the current car? 
   ...
   /* public static void main(String[] args) {
        ...
        AnimateThread demoThread = new AnimateThread(table, 60, 5);
        stepBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
                demoThread.run();
            }
        }); 
        //stepBtn.doClick(1000);
